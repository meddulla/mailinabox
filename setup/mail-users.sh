...
if [ ! -f $db_path ]; then
	...
	echo "CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT, email TEXT NOT NULL UNIQUE, password TEXT NOT NULL, extra, privileges TEXT NOT NULL DEFAULT '', quota varchar(10) DEFAULT '0');" | sqlite3 $db_path;
